...
# Launch file for the elfin5 Robot GAZEBO SIMULATION in ROS2 Humble:
...
def generate_launch_description():
    ...
    elfin5_ros2_gazebo = os.path.join(
        get_package_share_directory("elfin5_ros2_gazebo"), "worlds", "elfin5.world"
    )
    ...
    xacro_file = os.path.join(elfin5_description_path, "urdf", "elfin5.urdf.xacro")
