...
def generate_launch_description():
    ...
    xacro_file = os.path.join(
        elfin10_l_description_path, "urdf", "elfin10_l.urdf.xacro"
    )
    ...
    kinematics_yaml = load_yaml("elfin10_l_ros2_moveit2", "config/kinematics.yaml")
    ...
    rviz_base = os.path.join(
        get_package_share_directory("elfin10_l_ros2_moveit2"), "launch"
    )
