...
def generate_launch_description():
    ...
    elfin15_ros2_gazebo = os.path.join(
        get_package_share_directory("elfin15_ros2_gazebo"), "worlds", "elfin15.world"
    )
    ...
    xacro_file = os.path.join(elfin15_description_path, "urdf", "elfin15.urdf.xacro")
    ...
    kinematics_yaml = load_yaml("elfin15_ros2_moveit2", "config/kinematics.yaml")
    ...
    ompl_planning_yaml = load_yaml("elfin15_ros2_moveit2", "config/ompl_planning.yaml")
    ...
    rviz_base = os.path.join(
        get_package_share_directory("elfin15_ros2_moveit2"), "launch"
    )
