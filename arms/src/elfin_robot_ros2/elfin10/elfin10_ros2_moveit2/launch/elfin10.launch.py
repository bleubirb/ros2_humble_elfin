...
# elfin10.launch.py:
# Launch file for the elfin10 Robot GAZEBO + MoveIt!2 SIMULATION in ROS2 Humble:
...
def generate_launch_description():
    ...
    elfin10_ros2_gazebo = os.path.join(
        get_package_share_directory("elfin10_ros2_gazebo"), "worlds", "elfin10.world"
    )
    ...
    xacro_file = os.path.join(elfin10_description_path, "urdf", "elfin10.urdf.xacro")
    # Generate ROBOT_DESCRIPTION for elfin10:
    ...
    kinematics_yaml = load_yaml("elfin10_ros2_moveit2", "config/kinematics.yaml")
    ...
    ompl_planning_yaml = load_yaml("elfin10_ros2_moveit2", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # MoveIt!2 Controllers:
    moveit_simple_controllers_yaml = load_yaml(
        "elfin10_ros2_moveit2", "config/elfin_controllers.yaml"
    )
    moveit_controllers = {
    ...
    rviz_base = os.path.join(
        get_package_share_directory("elfin10_ros2_moveit2"), "launch"
    )
    rviz_full_config = os.path.join(rviz_base, "elfin10_moveit2.rviz")
    rviz_node_full = Node(
        package="rviz2",
        executable="rviz2",
        name="rviz2",
